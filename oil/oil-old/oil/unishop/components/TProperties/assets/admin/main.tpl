<div class="clearfix">
    <input type="text" id="prorerties_filter" style="width: 300px;" placeholder="{lang('Start typing property name here','unishop')}">
    <button type="button" class="pull-right btn btn-small action_on formSubmit btn-primary" data-form="#component_{echo $handler}_form" data-action="close">
        <i class="icon-ok icon-white"></i>{lang('Save', 'unishop')}
    </button>
</div>
