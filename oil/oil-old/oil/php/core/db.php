...
Class MySQL
{
	...
	function connect_zakaz ()
	{
           $conn = mysql_connect($this->server_zakaz,$this->user_zakaz,$this->pas_zakaz);
	...
	function connect_other ($server_other,$user_other,$pas_other,$dbase_other)
	{
        $conn = mysql_connect($server_other,$user_other,$pas_other);
...
$db->server_zakaz=DB_SERVER_ZAKAZ;
$db->dbase_zakaz=DB_NAME_ZAKAZ;
$db->user_zakaz=DB_USER_ZAKAZ;
$db->pas_zakaz=DB_PASS_ZAKAZ;
