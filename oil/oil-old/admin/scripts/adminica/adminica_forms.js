function adminicaForms(){
	...
	if($.fn.dialog){
		...
		$(".close_dialog_this_dialog").live("click", function() {
			idElement = $(this).parent('div.dialog_content').attr('id');
			$("#" + idElement).dialog( "close" ); // the #dialog element activates the modal box specified above
			return false;
		});
